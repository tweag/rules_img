...
// 	protoc        v5.27.3
// source: src/main/java/com/google/devtools/build/lib/buildeventstream/build_event_stream.proto

package buildeventstream

import (
	metrics "github.com/bazel-contrib/rules_img/img_tool/pkg/proto/bazel/src/main/java/com/google/devtools/build/lib/packages/metrics"
	protobuf "github.com/bazel-contrib/rules_img/img_tool/pkg/proto/bazel/src/main/protobuf"
...
func (TestSize) Descriptor() protoreflect.EnumDescriptor {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[0].Descriptor()
}

func (TestSize) Type() protoreflect.EnumType {
	return &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[0]
}
...
func (TestSize) EnumDescriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0}
}
...
func (TestStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[1].Descriptor()
}

func (TestStatus) Type() protoreflect.EnumType {
	return &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[1]
}
...
func (TestStatus) EnumDescriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{1}
}

type BuildEventId_FetchId_Downloader int32

const (
	BuildEventId_FetchId_UNKNOWN BuildEventId_FetchId_Downloader = 0
	BuildEventId_FetchId_HTTP    BuildEventId_FetchId_Downloader = 1
	BuildEventId_FetchId_GRPC    BuildEventId_FetchId_Downloader = 2
)

// Enum value maps for BuildEventId_FetchId_Downloader.
var (
	BuildEventId_FetchId_Downloader_name = map[int32]string{
		0: "UNKNOWN",
		1: "HTTP",
		2: "GRPC",
	}
	BuildEventId_FetchId_Downloader_value = map[string]int32{
		"UNKNOWN": 0,
		"HTTP":    1,
		"GRPC":    2,
	}
...
func (x BuildEventId_FetchId_Downloader) Enum() *BuildEventId_FetchId_Downloader {
	p := new(BuildEventId_FetchId_Downloader)
	*p = x
	return p
}

func (x BuildEventId_FetchId_Downloader) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BuildEventId_FetchId_Downloader) Descriptor() protoreflect.EnumDescriptor {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[2].Descriptor()
}

func (BuildEventId_FetchId_Downloader) Type() protoreflect.EnumType {
	return &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[2]
}

func (x BuildEventId_FetchId_Downloader) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BuildEventId_FetchId_Downloader.Descriptor instead.
func (BuildEventId_FetchId_Downloader) EnumDescriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 7, 0}
}
...
func (Aborted_AbortReason) Descriptor() protoreflect.EnumDescriptor {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[3].Descriptor()
}

func (Aborted_AbortReason) Type() protoreflect.EnumType {
	return &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[3]
}
...
func (Aborted_AbortReason) EnumDescriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{2, 0}
}
...
func (BuildMetrics_WorkerMetrics_WorkerStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[4].Descriptor()
}

func (BuildMetrics_WorkerMetrics_WorkerStatus) Type() protoreflect.EnumType {
	return &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[4]
}
...
func (BuildMetrics_WorkerMetrics_WorkerStatus) EnumDescriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 9, 0}
}
...
func (ConvenienceSymlink_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[5].Descriptor()
}

func (ConvenienceSymlink_Action) Type() protoreflect.EnumType {
	return &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes[5]
}
...
func (ConvenienceSymlink_Action) EnumDescriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{26, 0}
}
...
func (x *BuildEventId) Reset() {
	*x = BuildEventId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[0]
...
func (x *Progress) Reset() {
	*x = Progress{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Aborted) Reset() {
	*x = Aborted{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Aborted) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{2}
}
...
type BuildStarted struct {
	...
	// Deprecated: Marked as deprecated in src/main/java/com/google/devtools/build/lib/buildeventstream/build_event_stream.proto.
...
func (x *BuildStarted) Reset() {
	*x = BuildStarted{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildStarted) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{3}
}
...
func (x *WorkspaceConfig) Reset() {
	*x = WorkspaceConfig{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkspaceConfig) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{4}
}
...
func (x *UnstructuredCommandLine) Reset() {
	*x = UnstructuredCommandLine{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnstructuredCommandLine) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{5}
}
...
func (x *OptionsParsed) Reset() {
	*x = OptionsParsed{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OptionsParsed) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{6}
}
...
func (x *OptionsParsed) GetInvocationPolicy() *protobuf.InvocationPolicy {
	if x != nil {
...
func (x *Fetch) Reset() {
	*x = Fetch{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Fetch) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{7}
}
...
func (x *WorkspaceStatus) Reset() {
	*x = WorkspaceStatus{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkspaceStatus) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{8}
}
...
func (x *BuildMetadata) Reset() {
	*x = BuildMetadata{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetadata) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{9}
}
...
func (x *Configuration) Reset() {
	*x = Configuration{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Configuration) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{10}
}
...
func (x *PatternExpanded) Reset() {
	*x = PatternExpanded{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PatternExpanded) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{11}
}
...
func (x *TargetConfigured) Reset() {
	*x = TargetConfigured{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TargetConfigured) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{12}
}
...
func (x *File) Reset() {
	*x = File{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*File) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{13}
}
...
func (x *NamedSetOfFiles) Reset() {
	*x = NamedSetOfFiles{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NamedSetOfFiles) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{14}
}
...
type ActionExecuted struct {
	...
	FailureDetail   *protobuf.FailureDetail       `protobuf:"bytes,11,opt,name=failure_detail,json=failureDetail,proto3" json:"failure_detail,omitempty"`
...
func (x *ActionExecuted) Reset() {
	*x = ActionExecuted{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActionExecuted) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{15}
}
...
func (x *ActionExecuted) GetFailureDetail() *protobuf.FailureDetail {
	if x != nil {
...
type OutputGroup struct {
	...
	InlineFiles   []*File                           `protobuf:"bytes,5,rep,name=inline_files,json=inlineFiles,proto3" json:"inline_files,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OutputGroup) Reset() {
	*x = OutputGroup{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OutputGroup) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{16}
}
...
func (x *OutputGroup) GetInlineFiles() []*File {
	if x != nil {
...
type TargetComplete struct {
	...
	FailureDetail      *protobuf.FailureDetail `protobuf:"bytes,9,opt,name=failure_detail,json=failureDetail,proto3" json:"failure_detail,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *TargetComplete) Reset() {
	*x = TargetComplete{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TargetComplete) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{17}
}
...
func (x *TargetComplete) GetFailureDetail() *protobuf.FailureDetail {
	if x != nil {
		return x.FailureDetail
	}
	return nil
...
func (x *TestResult) Reset() {
	*x = TestResult{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TestResult) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{18}
}
...
func (x *TestProgress) Reset() {
	*x = TestProgress{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TestProgress) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{19}
}
...
func (x *TestSummary) Reset() {
	*x = TestSummary{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TestSummary) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{20}
}
...
func (x *TargetSummary) Reset() {
	*x = TargetSummary{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TargetSummary) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{21}
}
...
type BuildFinished struct {
	...
	FailureDetail *protobuf.FailureDetail      `protobuf:"bytes,6,opt,name=failure_detail,json=failureDetail,proto3" json:"failure_detail,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BuildFinished) Reset() {
	*x = BuildFinished{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildFinished) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{22}
}
...
func (x *BuildFinished) GetFailureDetail() *protobuf.FailureDetail {
	if x != nil {
		return x.FailureDetail
	}
	return nil
...
type BuildMetrics struct {
	...
	RemoteAnalysisCacheStatistics *BuildMetrics_RemoteAnalysisCacheStatistics `protobuf:"bytes,13,opt,name=remote_analysis_cache_statistics,json=remoteAnalysisCacheStatistics,proto3" json:"remote_analysis_cache_statistics,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *BuildMetrics) Reset() {
	*x = BuildMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23}
}
...
func (x *BuildMetrics) GetRemoteAnalysisCacheStatistics() *BuildMetrics_RemoteAnalysisCacheStatistics {
	if x != nil {
		return x.RemoteAnalysisCacheStatistics
	}
	return nil
}
...
func (x *BuildToolLogs) Reset() {
	*x = BuildToolLogs{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildToolLogs) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{24}
}
...
func (x *ConvenienceSymlinksIdentified) Reset() {
	*x = ConvenienceSymlinksIdentified{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConvenienceSymlinksIdentified) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{25}
}
...
func (x *ConvenienceSymlink) Reset() {
	*x = ConvenienceSymlink{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConvenienceSymlink) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{26}
}
...
func (x *ExecRequestConstructed) Reset() {
	*x = ExecRequestConstructed{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExecRequestConstructed) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{27}
}
...
func (x *EnvironmentVariable) Reset() {
	*x = EnvironmentVariable{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EnvironmentVariable) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{28}
}
...
func (x *BuildEvent) Reset() {
	*x = BuildEvent{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEvent) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{29}
}
...
func (x *BuildEvent) GetStructuredCommandLine() *protobuf.CommandLine {
	if x != nil {
...
func (x *BuildEventId_UnknownBuildEventId) Reset() {
	*x = BuildEventId_UnknownBuildEventId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_UnknownBuildEventId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BuildEventId_ProgressId) Reset() {
	*x = BuildEventId_ProgressId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_ProgressId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *BuildEventId_BuildStartedId) Reset() {
	*x = BuildEventId_BuildStartedId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_BuildStartedId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *BuildEventId_UnstructuredCommandLineId) Reset() {
	*x = BuildEventId_UnstructuredCommandLineId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_UnstructuredCommandLineId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *BuildEventId_StructuredCommandLineId) Reset() {
	*x = BuildEventId_StructuredCommandLineId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_StructuredCommandLineId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 4}
}
...
func (x *BuildEventId_WorkspaceStatusId) Reset() {
	*x = BuildEventId_WorkspaceStatusId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_WorkspaceStatusId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 5}
}
...
func (x *BuildEventId_OptionsParsedId) Reset() {
	*x = BuildEventId_OptionsParsedId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_OptionsParsedId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 6}
}

type BuildEventId_FetchId struct {
	state         protoimpl.MessageState          `protogen:"open.v1"`
	Url           string                          `protobuf:"bytes,1,opt,name=url,proto3" json:"url,omitempty"`
	Downloader    BuildEventId_FetchId_Downloader `protobuf:"varint,2,opt,name=downloader,proto3,enum=build_event_stream.BuildEventId_FetchId_Downloader" json:"downloader,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BuildEventId_FetchId) Reset() {
	*x = BuildEventId_FetchId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_FetchId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 7}
}
...
func (x *BuildEventId_FetchId) GetDownloader() BuildEventId_FetchId_Downloader {
	if x != nil {
		return x.Downloader
	}
	return BuildEventId_FetchId_UNKNOWN
}
...
func (x *BuildEventId_PatternExpandedId) Reset() {
	*x = BuildEventId_PatternExpandedId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_PatternExpandedId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 8}
}
...
func (x *BuildEventId_WorkspaceConfigId) Reset() {
	*x = BuildEventId_WorkspaceConfigId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_WorkspaceConfigId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 9}
}
...
func (x *BuildEventId_BuildMetadataId) Reset() {
	*x = BuildEventId_BuildMetadataId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_BuildMetadataId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 10}
}
...
func (x *BuildEventId_TargetConfiguredId) Reset() {
	*x = BuildEventId_TargetConfiguredId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_TargetConfiguredId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 11}
}
...
func (x *BuildEventId_NamedSetOfFilesId) Reset() {
	*x = BuildEventId_NamedSetOfFilesId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_NamedSetOfFilesId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 12}
}
...
func (x *BuildEventId_ConfigurationId) Reset() {
	*x = BuildEventId_ConfigurationId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_ConfigurationId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 13}
}
...
func (x *BuildEventId_TargetCompletedId) Reset() {
	*x = BuildEventId_TargetCompletedId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_TargetCompletedId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 14}
}
...
func (x *BuildEventId_ActionCompletedId) Reset() {
	*x = BuildEventId_ActionCompletedId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_ActionCompletedId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 15}
}
...
func (x *BuildEventId_UnconfiguredLabelId) Reset() {
	*x = BuildEventId_UnconfiguredLabelId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_UnconfiguredLabelId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 16}
}
...
func (x *BuildEventId_ConfiguredLabelId) Reset() {
	*x = BuildEventId_ConfiguredLabelId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_ConfiguredLabelId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 17}
}
...
func (x *BuildEventId_TestResultId) Reset() {
	*x = BuildEventId_TestResultId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[48]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_TestResultId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 18}
}
...
func (x *BuildEventId_TestProgressId) Reset() {
	*x = BuildEventId_TestProgressId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[49]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_TestProgressId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 19}
}
...
func (x *BuildEventId_TestSummaryId) Reset() {
	*x = BuildEventId_TestSummaryId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_TestSummaryId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 20}
}
...
func (x *BuildEventId_TargetSummaryId) Reset() {
	*x = BuildEventId_TargetSummaryId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_TargetSummaryId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 21}
}
...
func (x *BuildEventId_BuildFinishedId) Reset() {
	*x = BuildEventId_BuildFinishedId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[52]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_BuildFinishedId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 22}
}
...
func (x *BuildEventId_BuildToolLogsId) Reset() {
	*x = BuildEventId_BuildToolLogsId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_BuildToolLogsId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 23}
}
...
func (x *BuildEventId_BuildMetricsId) Reset() {
	*x = BuildEventId_BuildMetricsId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_BuildMetricsId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 24}
}
...
func (x *BuildEventId_ConvenienceSymlinksIdentifiedId) Reset() {
	*x = BuildEventId_ConvenienceSymlinksIdentifiedId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_ConvenienceSymlinksIdentifiedId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 25}
}
...
func (x *BuildEventId_ExecRequestId) Reset() {
	*x = BuildEventId_ExecRequestId{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildEventId_ExecRequestId) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{0, 26}
}
...
func (x *WorkspaceStatus_Item) Reset() {
	*x = WorkspaceStatus_Item{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[57]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkspaceStatus_Item) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{8, 0}
}
...
func (x *PatternExpanded_TestSuiteExpansion) Reset() {
	*x = PatternExpanded_TestSuiteExpansion{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PatternExpanded_TestSuiteExpansion) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{11, 0}
}
...
func (x *TestResult_ExecutionInfo) Reset() {
	*x = TestResult_ExecutionInfo{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TestResult_ExecutionInfo) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{18, 0}
}
...
func (x *TestResult_ExecutionInfo_TimingBreakdown) Reset() {
	*x = TestResult_ExecutionInfo_TimingBreakdown{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TestResult_ExecutionInfo_TimingBreakdown) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{18, 0, 0}
}
...
func (x *TestResult_ExecutionInfo_ResourceUsage) Reset() {
	*x = TestResult_ExecutionInfo_ResourceUsage{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TestResult_ExecutionInfo_ResourceUsage) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{18, 0, 1}
}
...
func (x *BuildFinished_ExitCode) Reset() {
	*x = BuildFinished_ExitCode{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildFinished_ExitCode) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{22, 0}
}
...
func (x *BuildFinished_AnomalyReport) Reset() {
	*x = BuildFinished_AnomalyReport{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[65]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildFinished_AnomalyReport) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{22, 1}
}
...
type BuildMetrics_ActionSummary struct {
	...
	ActionCacheStatistics *protobuf.ActionCacheStatistics           `protobuf:"bytes,7,opt,name=action_cache_statistics,json=actionCacheStatistics,proto3" json:"action_cache_statistics,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *BuildMetrics_ActionSummary) Reset() {
	*x = BuildMetrics_ActionSummary{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[66]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_ActionSummary) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 0}
}
...
func (x *BuildMetrics_ActionSummary) GetActionCacheStatistics() *protobuf.ActionCacheStatistics {
	if x != nil {
...
func (x *BuildMetrics_MemoryMetrics) Reset() {
	*x = BuildMetrics_MemoryMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[67]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_MemoryMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 1}
}
...
func (x *BuildMetrics_TargetMetrics) Reset() {
	*x = BuildMetrics_TargetMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[68]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_TargetMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 2}
}
...
type BuildMetrics_PackageMetrics struct {
	...
	PackageLoadMetrics []*metrics.PackageLoadMetrics `protobuf:"bytes,2,rep,name=package_load_metrics,json=packageLoadMetrics,proto3" json:"package_load_metrics,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *BuildMetrics_PackageMetrics) Reset() {
	*x = BuildMetrics_PackageMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[69]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_PackageMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 3}
}
...
func (x *BuildMetrics_PackageMetrics) GetPackageLoadMetrics() []*metrics.PackageLoadMetrics {
	if x != nil {
...
type BuildMetrics_TimingMetrics struct {
	...
	CriticalPathTime          *durationpb.Duration   `protobuf:"bytes,6,opt,name=critical_path_time,json=criticalPathTime,proto3" json:"critical_path_time,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *BuildMetrics_TimingMetrics) Reset() {
	*x = BuildMetrics_TimingMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[70]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_TimingMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 4}
}
...
func (x *BuildMetrics_TimingMetrics) GetCriticalPathTime() *durationpb.Duration {
	if x != nil {
...
func (x *BuildMetrics_CumulativeMetrics) Reset() {
	*x = BuildMetrics_CumulativeMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[71]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_CumulativeMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 5}
}
...
func (x *BuildMetrics_ArtifactMetrics) Reset() {
	*x = BuildMetrics_ArtifactMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[72]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_ArtifactMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 6}
}
...
type BuildMetrics_EvaluationStat struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	SkyfunctionName string                 `protobuf:"bytes,1,opt,name=skyfunction_name,json=skyfunctionName,proto3" json:"skyfunction_name,omitempty"`
	Count           int64                  `protobuf:"varint,2,opt,name=count,proto3" json:"count,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *BuildMetrics_EvaluationStat) Reset() {
	*x = BuildMetrics_EvaluationStat{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[73]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BuildMetrics_EvaluationStat) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuildMetrics_EvaluationStat) ProtoMessage() {}

func (x *BuildMetrics_EvaluationStat) ProtoReflect() protoreflect.Message {
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[73]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuildMetrics_EvaluationStat.ProtoReflect.Descriptor instead.
func (*BuildMetrics_EvaluationStat) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 7}
}

func (x *BuildMetrics_EvaluationStat) GetSkyfunctionName() string {
	if x != nil {
		return x.SkyfunctionName
	}
	return ""
}

func (x *BuildMetrics_EvaluationStat) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
type BuildMetrics_BuildGraphMetrics struct {
	...
	DirtiedValues                             []*BuildMetrics_EvaluationStat                   `protobuf:"bytes,10,rep,name=dirtied_values,json=dirtiedValues,proto3" json:"dirtied_values,omitempty"`
	ChangedValues                             []*BuildMetrics_EvaluationStat                   `protobuf:"bytes,11,rep,name=changed_values,json=changedValues,proto3" json:"changed_values,omitempty"`
	BuiltValues                               []*BuildMetrics_EvaluationStat                   `protobuf:"bytes,12,rep,name=built_values,json=builtValues,proto3" json:"built_values,omitempty"`
	CleanedValues                             []*BuildMetrics_EvaluationStat                   `protobuf:"bytes,13,rep,name=cleaned_values,json=cleanedValues,proto3" json:"cleaned_values,omitempty"`
	EvaluatedValues                           []*BuildMetrics_EvaluationStat                   `protobuf:"bytes,17,rep,name=evaluated_values,json=evaluatedValues,proto3" json:"evaluated_values,omitempty"`
	RuleClass                                 []*BuildMetrics_BuildGraphMetrics_RuleClassCount `protobuf:"bytes,14,rep,name=rule_class,json=ruleClass,proto3" json:"rule_class,omitempty"`
	Aspect                                    []*BuildMetrics_BuildGraphMetrics_AspectCount    `protobuf:"bytes,15,rep,name=aspect,proto3" json:"aspect,omitempty"`
	unknownFields                             protoimpl.UnknownFields
	sizeCache                                 protoimpl.SizeCache
}
...
func (x *BuildMetrics_BuildGraphMetrics) Reset() {
	*x = BuildMetrics_BuildGraphMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[74]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_BuildGraphMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 8}
}
...
func (x *BuildMetrics_BuildGraphMetrics) GetDirtiedValues() []*BuildMetrics_EvaluationStat {
	if x != nil {
		return x.DirtiedValues
	}
	return nil
}

func (x *BuildMetrics_BuildGraphMetrics) GetChangedValues() []*BuildMetrics_EvaluationStat {
	if x != nil {
		return x.ChangedValues
	}
	return nil
}

func (x *BuildMetrics_BuildGraphMetrics) GetBuiltValues() []*BuildMetrics_EvaluationStat {
	if x != nil {
		return x.BuiltValues
	}
	return nil
}

func (x *BuildMetrics_BuildGraphMetrics) GetCleanedValues() []*BuildMetrics_EvaluationStat {
	if x != nil {
		return x.CleanedValues
	}
	return nil
}

func (x *BuildMetrics_BuildGraphMetrics) GetEvaluatedValues() []*BuildMetrics_EvaluationStat {
	if x != nil {
		return x.EvaluatedValues
	}
	return nil
}

func (x *BuildMetrics_BuildGraphMetrics) GetRuleClass() []*BuildMetrics_BuildGraphMetrics_RuleClassCount {
	if x != nil {
		return x.RuleClass
	}
	return nil
...
func (x *BuildMetrics_BuildGraphMetrics) GetAspect() []*BuildMetrics_BuildGraphMetrics_AspectCount {
	if x != nil {
		return x.Aspect
	}
	return nil
...
type BuildMetrics_WorkerMetrics struct {
	...
	Code                 *protobuf.Worker_Code                     `protobuf:"varint,12,opt,name=code,proto3,enum=failure_details.Worker_Code,oneof" json:"code,omitempty"`
...
func (x *BuildMetrics_WorkerMetrics) Reset() {
	*x = BuildMetrics_WorkerMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[75]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_WorkerMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 9}
}
...
func (x *BuildMetrics_WorkerMetrics) GetCode() protobuf.Worker_Code {
	if x != nil && x.Code != nil {
		return *x.Code
	}
	return protobuf.Worker_Code(0)
}
...
func (x *BuildMetrics_NetworkMetrics) Reset() {
	*x = BuildMetrics_NetworkMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[76]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_NetworkMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 10}
}
...
func (x *BuildMetrics_WorkerPoolMetrics) Reset() {
	*x = BuildMetrics_WorkerPoolMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[77]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_WorkerPoolMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 11}
}
...
func (x *BuildMetrics_DynamicExecutionMetrics) Reset() {
	*x = BuildMetrics_DynamicExecutionMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[78]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_DynamicExecutionMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 12}
}
...
type BuildMetrics_RemoteAnalysisCacheStatistics struct {
	state                        protoimpl.MessageState `protogen:"open.v1"`
	CacheHits                    int64                  `protobuf:"varint,1,opt,name=cache_hits,json=cacheHits,proto3" json:"cache_hits,omitempty"`
	CacheMisses                  int64                  `protobuf:"varint,2,opt,name=cache_misses,json=cacheMisses,proto3" json:"cache_misses,omitempty"`
	ValueStoreValueBytesReceived int64                  `protobuf:"varint,3,opt,name=value_store_value_bytes_received,json=valueStoreValueBytesReceived,proto3" json:"value_store_value_bytes_received,omitempty"`
	ValueStoreValueBytesSent     int64                  `protobuf:"varint,4,opt,name=value_store_value_bytes_sent,json=valueStoreValueBytesSent,proto3" json:"value_store_value_bytes_sent,omitempty"`
	ValueStoreKeyBytesSent       int64                  `protobuf:"varint,5,opt,name=value_store_key_bytes_sent,json=valueStoreKeyBytesSent,proto3" json:"value_store_key_bytes_sent,omitempty"`
	ValueStoreWriteOps           int64                  `protobuf:"varint,6,opt,name=value_store_write_ops,json=valueStoreWriteOps,proto3" json:"value_store_write_ops,omitempty"`
	ValueStoreReadOpsSuccessful  int64                  `protobuf:"varint,7,opt,name=value_store_read_ops_successful,json=valueStoreReadOpsSuccessful,proto3" json:"value_store_read_ops_successful,omitempty"`
	ValueStoreReadOpsNotFound    int64                  `protobuf:"varint,8,opt,name=value_store_read_ops_not_found,json=valueStoreReadOpsNotFound,proto3" json:"value_store_read_ops_not_found,omitempty"`
	ValueStoreReadBatches        int64                  `protobuf:"varint,10,opt,name=value_store_read_batches,json=valueStoreReadBatches,proto3" json:"value_store_read_batches,omitempty"`
	ValueStoreWriteBatches       int64                  `protobuf:"varint,11,opt,name=value_store_write_batches,json=valueStoreWriteBatches,proto3" json:"value_store_write_batches,omitempty"`
	AnalysisCacheBytesReceived   int64                  `protobuf:"varint,12,opt,name=analysis_cache_bytes_received,json=analysisCacheBytesReceived,proto3" json:"analysis_cache_bytes_received,omitempty"`
	AnalysisCacheKeyBytesSent    int64                  `protobuf:"varint,13,opt,name=analysis_cache_key_bytes_sent,json=analysisCacheKeyBytesSent,proto3" json:"analysis_cache_key_bytes_sent,omitempty"`
	AnalysisCacheOps             int64                  `protobuf:"varint,14,opt,name=analysis_cache_ops,json=analysisCacheOps,proto3" json:"analysis_cache_ops,omitempty"`
	AnalysisCacheBatches         int64                  `protobuf:"varint,15,opt,name=analysis_cache_batches,json=analysisCacheBatches,proto3" json:"analysis_cache_batches,omitempty"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) Reset() {
	*x = BuildMetrics_RemoteAnalysisCacheStatistics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[79]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuildMetrics_RemoteAnalysisCacheStatistics) ProtoMessage() {}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) ProtoReflect() protoreflect.Message {
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[79]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuildMetrics_RemoteAnalysisCacheStatistics.ProtoReflect.Descriptor instead.
func (*BuildMetrics_RemoteAnalysisCacheStatistics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 13}
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetCacheHits() int64 {
	if x != nil {
		return x.CacheHits
	}
	return 0
...
func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetCacheMisses() int64 {
	if x != nil {
...
func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreValueBytesReceived() int64 {
	if x != nil {
		return x.ValueStoreValueBytesReceived
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreValueBytesSent() int64 {
	if x != nil {
		return x.ValueStoreValueBytesSent
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreKeyBytesSent() int64 {
	if x != nil {
		return x.ValueStoreKeyBytesSent
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreWriteOps() int64 {
	if x != nil {
		return x.ValueStoreWriteOps
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreReadOpsSuccessful() int64 {
	if x != nil {
		return x.ValueStoreReadOpsSuccessful
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreReadOpsNotFound() int64 {
	if x != nil {
		return x.ValueStoreReadOpsNotFound
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreReadBatches() int64 {
	if x != nil {
		return x.ValueStoreReadBatches
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreWriteBatches() int64 {
	if x != nil {
		return x.ValueStoreWriteBatches
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetAnalysisCacheBytesReceived() int64 {
	if x != nil {
		return x.AnalysisCacheBytesReceived
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetAnalysisCacheKeyBytesSent() int64 {
	if x != nil {
		return x.AnalysisCacheKeyBytesSent
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetAnalysisCacheOps() int64 {
	if x != nil {
		return x.AnalysisCacheOps
	}
	return 0
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetAnalysisCacheBatches() int64 {
	if x != nil {
		return x.AnalysisCacheBatches
	}
	return 0
}
...
type BuildMetrics_ActionSummary_ActionData struct {
	...
	ActionsCreated  int64                  `protobuf:"varint,7,opt,name=actions_created,json=actionsCreated,proto3" json:"actions_created,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *BuildMetrics_ActionSummary_ActionData) Reset() {
	*x = BuildMetrics_ActionSummary_ActionData{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[80]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_ActionSummary_ActionData) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 0, 0}
}
...
func (x *BuildMetrics_ActionSummary_ActionData) GetActionsCreated() int64 {
	if x != nil {
		return x.ActionsCreated
	}
	return 0
...
func (x *BuildMetrics_ActionSummary_RunnerCount) Reset() {
	*x = BuildMetrics_ActionSummary_RunnerCount{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[81]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_ActionSummary_RunnerCount) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 0, 1}
}
...
func (x *BuildMetrics_MemoryMetrics_GarbageMetrics) Reset() {
	*x = BuildMetrics_MemoryMetrics_GarbageMetrics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[82]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_MemoryMetrics_GarbageMetrics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 1, 0}
}
...
func (x *BuildMetrics_ArtifactMetrics_FilesMetric) Reset() {
	*x = BuildMetrics_ArtifactMetrics_FilesMetric{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[83]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_ArtifactMetrics_FilesMetric) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 6, 0}
}
...
type BuildMetrics_BuildGraphMetrics_RuleClassCount struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           string                 `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	RuleClass     string                 `protobuf:"bytes,2,opt,name=rule_class,json=ruleClass,proto3" json:"rule_class,omitempty"`
	Count         uint64                 `protobuf:"varint,3,opt,name=count,proto3" json:"count,omitempty"`
	ActionCount   uint64                 `protobuf:"varint,4,opt,name=action_count,json=actionCount,proto3" json:"action_count,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BuildMetrics_BuildGraphMetrics_RuleClassCount) Reset() {
	*x = BuildMetrics_BuildGraphMetrics_RuleClassCount{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[84]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BuildMetrics_BuildGraphMetrics_RuleClassCount) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuildMetrics_BuildGraphMetrics_RuleClassCount) ProtoMessage() {}

func (x *BuildMetrics_BuildGraphMetrics_RuleClassCount) ProtoReflect() protoreflect.Message {
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[84]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuildMetrics_BuildGraphMetrics_RuleClassCount.ProtoReflect.Descriptor instead.
func (*BuildMetrics_BuildGraphMetrics_RuleClassCount) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 8, 0}
}

func (x *BuildMetrics_BuildGraphMetrics_RuleClassCount) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *BuildMetrics_BuildGraphMetrics_RuleClassCount) GetRuleClass() string {
	if x != nil {
		return x.RuleClass
	}
	return ""
...
func (x *BuildMetrics_BuildGraphMetrics_RuleClassCount) GetCount() uint64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *BuildMetrics_BuildGraphMetrics_RuleClassCount) GetActionCount() uint64 {
	if x != nil {
		return x.ActionCount
	}
	return 0
...
type BuildMetrics_BuildGraphMetrics_AspectCount struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           string                 `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	AspectName    string                 `protobuf:"bytes,2,opt,name=aspect_name,json=aspectName,proto3" json:"aspect_name,omitempty"`
	Count         uint64                 `protobuf:"varint,3,opt,name=count,proto3" json:"count,omitempty"`
	ActionCount   uint64                 `protobuf:"varint,4,opt,name=action_count,json=actionCount,proto3" json:"action_count,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *BuildMetrics_BuildGraphMetrics_AspectCount) Reset() {
	*x = BuildMetrics_BuildGraphMetrics_AspectCount{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[85]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BuildMetrics_BuildGraphMetrics_AspectCount) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuildMetrics_BuildGraphMetrics_AspectCount) ProtoMessage() {}

func (x *BuildMetrics_BuildGraphMetrics_AspectCount) ProtoReflect() protoreflect.Message {
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[85]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuildMetrics_BuildGraphMetrics_AspectCount.ProtoReflect.Descriptor instead.
func (*BuildMetrics_BuildGraphMetrics_AspectCount) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 8, 1}
}

func (x *BuildMetrics_BuildGraphMetrics_AspectCount) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *BuildMetrics_BuildGraphMetrics_AspectCount) GetAspectName() string {
	if x != nil {
		return x.AspectName
	}
	return ""
...
func (x *BuildMetrics_BuildGraphMetrics_AspectCount) GetCount() uint64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *BuildMetrics_BuildGraphMetrics_AspectCount) GetActionCount() uint64 {
	if x != nil {
		return x.ActionCount
	}
	return 0
...
func (x *BuildMetrics_WorkerMetrics_WorkerStats) Reset() {
	*x = BuildMetrics_WorkerMetrics_WorkerStats{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[86]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *BuildMetrics_NetworkMetrics_SystemNetworkStats) Reset() {
	*x = BuildMetrics_NetworkMetrics_SystemNetworkStats{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[87]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_NetworkMetrics_SystemNetworkStats) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 10, 0}
}
...
func (x *BuildMetrics_WorkerPoolMetrics_WorkerPoolStats) Reset() {
	*x = BuildMetrics_WorkerPoolMetrics_WorkerPoolStats{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[88]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_WorkerPoolMetrics_WorkerPoolStats) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 11, 0}
}
...
func (x *BuildMetrics_DynamicExecutionMetrics_RaceStatistics) Reset() {
	*x = BuildMetrics_DynamicExecutionMetrics_RaceStatistics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[89]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildMetrics_DynamicExecutionMetrics_RaceStatistics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP(), []int{23, 12, 0}
}
...
var File_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto protoreflect.FileDescriptor

const file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDesc = "" +
	"\n" +
	"Usrc/main/java/com/google/devtools/build/lib/buildeventstream/build_event_stream.proto\x12\x12build_event_stream\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1aWsrc/main/java/com/google/devtools/build/lib/packages/metrics/package_load_metrics.proto\x1a$src/main/protobuf/action_cache.proto\x1a$src/main/protobuf/command_line.proto\x1a'src/main/protobuf/failure_details.proto\x1a)src/main/protobuf/invocation_policy.proto\"\xc6#\n" +
	"\fBuildEventId\x12P\n" +
	...
	"\x0fOptionsParsedId\x1a\x9f\x01\n" +
	"\aFetchId\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12S\n" +
	"\n" +
	"downloader\x18\x02 \x01(\x0e23.build_event_stream.BuildEventId.FetchId.DownloaderR\n" +
	"downloader\"-\n" +
	"\n" +
	"Downloader\x12\v\n" +
	...
	"\tfile_sets\x18\x02 \x03(\v22.build_event_stream.BuildEventId.NamedSetOfFilesIdR\bfileSets\"\x99\x05\n" +
	...
	"\fcommand_line\x18\t \x03(\tR\vcommandLine\x12E\n" +
	...
	"\x10strategy_details\x18\x0e \x03(\v2\x14.google.protobuf.AnyR\x0fstrategyDetailsJ\x04\b\n" +
	"\x10\v\"\xd5\x01\n" +
	...
	"\rAnomalyReport\x12#\n" +
	"\rwas_suspended\x18\x01 \x01(\bR\fwasSuspended\"\xf1E\n" +
	"\fBuildMetrics\x12U\n" +
	...
	"\x19dynamic_execution_metrics\x18\f \x01(\v28.build_event_stream.BuildMetrics.DynamicExecutionMetricsR\x17dynamicExecutionMetrics\x12\x87\x01\n" +
	" remote_analysis_cache_statistics\x18\r \x01(\v2>.build_event_stream.BuildMetrics.RemoteAnalysisCacheStatisticsR\x1dremoteAnalysisCacheStatistics\x1a\x8d\a\n" +
	"\rActionSummary\x12'\n" +
	...
	"\x14package_load_metrics\x18\x02 \x03(\v27.devtools.build.lib.packages.metrics.PackageLoadMetricsR\x12packageLoadMetrics\x1a\xdc\x02\n" +
	"\rTimingMetrics\x12#\n" +
	...
	"\x1dactions_execution_start_in_ms\x18\x05 \x01(\x03R\x19actionsExecutionStartInMs\x12G\n" +
	"\x12critical_path_time\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\x10criticalPathTime\x1aU\n" +
	...
	"remoteWins\x1a\xbe\x06\n" +
	"\x1dRemoteAnalysisCacheStatistics\x12\x1d\n" +
	"\n" +
	"cache_hits\x18\x01 \x01(\x03R\tcacheHits\x12!\n" +
	"\fcache_misses\x18\x02 \x01(\x03R\vcacheMisses\x12F\n" +
	" value_store_value_bytes_received\x18\x03 \x01(\x03R\x1cvalueStoreValueBytesReceived\x12>\n" +
	"\x1cvalue_store_value_bytes_sent\x18\x04 \x01(\x03R\x18valueStoreValueBytesSent\x12:\n" +
	"\x1avalue_store_key_bytes_sent\x18\x05 \x01(\x03R\x16valueStoreKeyBytesSent\x121\n" +
	"\x15value_store_write_ops\x18\x06 \x01(\x03R\x12valueStoreWriteOps\x12D\n" +
	"\x1fvalue_store_read_ops_successful\x18\a \x01(\x03R\x1bvalueStoreReadOpsSuccessful\x12A\n" +
	"\x1evalue_store_read_ops_not_found\x18\b \x01(\x03R\x19valueStoreReadOpsNotFound\x127\n" +
	"\x18value_store_read_batches\x18\n" +
	" \x01(\x03R\x15valueStoreReadBatches\x129\n" +
	"\x19value_store_write_batches\x18\v \x01(\x03R\x16valueStoreWriteBatches\x12A\n" +
	"\x1danalysis_cache_bytes_received\x18\f \x01(\x03R\x1aanalysisCacheBytesReceived\x12@\n" +
	"\x1danalysis_cache_key_bytes_sent\x18\r \x01(\x03R\x19analysisCacheKeyBytesSent\x12,\n" +
	"\x12analysis_cache_ops\x18\x0e \x01(\x03R\x10analysisCacheOps\x124\n" +
	"\x16analysis_cache_batches\x18\x0f \x01(\x03R\x14analysisCacheBatches\";\n" +
	"\rBuildToolLogs\x12*\n" +
...
var (
	file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescOnce sync.Once
	file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescData []byte
)

func file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescGZIP() []byte {
	file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescOnce.Do(func() {
		file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDesc), len(file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDesc)))
	})
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDescData
}

var file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 90)
var file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_goTypes = []any{
	(TestSize)(0),                                               // 0: build_event_stream.TestSize
	(TestStatus)(0),                                             // 1: build_event_stream.TestStatus
	(BuildEventId_FetchId_Downloader)(0),                        // 2: build_event_stream.BuildEventId.FetchId.Downloader
	(Aborted_AbortReason)(0),                                    // 3: build_event_stream.Aborted.AbortReason
	(BuildMetrics_WorkerMetrics_WorkerStatus)(0),                // 4: build_event_stream.BuildMetrics.WorkerMetrics.WorkerStatus
	(ConvenienceSymlink_Action)(0),                              // 5: build_event_stream.ConvenienceSymlink.Action
	(*BuildEventId)(nil),                                        // 6: build_event_stream.BuildEventId
	(*Progress)(nil),                                            // 7: build_event_stream.Progress
	(*Aborted)(nil),                                             // 8: build_event_stream.Aborted
	(*BuildStarted)(nil),                                        // 9: build_event_stream.BuildStarted
	(*WorkspaceConfig)(nil),                                     // 10: build_event_stream.WorkspaceConfig
	(*UnstructuredCommandLine)(nil),                             // 11: build_event_stream.UnstructuredCommandLine
	(*OptionsParsed)(nil),                                       // 12: build_event_stream.OptionsParsed
	(*Fetch)(nil),                                               // 13: build_event_stream.Fetch
	(*WorkspaceStatus)(nil),                                     // 14: build_event_stream.WorkspaceStatus
	(*BuildMetadata)(nil),                                       // 15: build_event_stream.BuildMetadata
	(*Configuration)(nil),                                       // 16: build_event_stream.Configuration
	(*PatternExpanded)(nil),                                     // 17: build_event_stream.PatternExpanded
	(*TargetConfigured)(nil),                                    // 18: build_event_stream.TargetConfigured
	(*File)(nil),                                                // 19: build_event_stream.File
	(*NamedSetOfFiles)(nil),                                     // 20: build_event_stream.NamedSetOfFiles
	(*ActionExecuted)(nil),                                      // 21: build_event_stream.ActionExecuted
	(*OutputGroup)(nil),                                         // 22: build_event_stream.OutputGroup
	(*TargetComplete)(nil),                                      // 23: build_event_stream.TargetComplete
	(*TestResult)(nil),                                          // 24: build_event_stream.TestResult
	(*TestProgress)(nil),                                        // 25: build_event_stream.TestProgress
	(*TestSummary)(nil),                                         // 26: build_event_stream.TestSummary
	(*TargetSummary)(nil),                                       // 27: build_event_stream.TargetSummary
	(*BuildFinished)(nil),                                       // 28: build_event_stream.BuildFinished
	(*BuildMetrics)(nil),                                        // 29: build_event_stream.BuildMetrics
	(*BuildToolLogs)(nil),                                       // 30: build_event_stream.BuildToolLogs
	(*ConvenienceSymlinksIdentified)(nil),                       // 31: build_event_stream.ConvenienceSymlinksIdentified
	(*ConvenienceSymlink)(nil),                                  // 32: build_event_stream.ConvenienceSymlink
	(*ExecRequestConstructed)(nil),                              // 33: build_event_stream.ExecRequestConstructed
	(*EnvironmentVariable)(nil),                                 // 34: build_event_stream.EnvironmentVariable
	(*BuildEvent)(nil),                                          // 35: build_event_stream.BuildEvent
	(*BuildEventId_UnknownBuildEventId)(nil),                    // 36: build_event_stream.BuildEventId.UnknownBuildEventId
	(*BuildEventId_ProgressId)(nil),                             // 37: build_event_stream.BuildEventId.ProgressId
	(*BuildEventId_BuildStartedId)(nil),                         // 38: build_event_stream.BuildEventId.BuildStartedId
	(*BuildEventId_UnstructuredCommandLineId)(nil),              // 39: build_event_stream.BuildEventId.UnstructuredCommandLineId
	(*BuildEventId_StructuredCommandLineId)(nil),                // 40: build_event_stream.BuildEventId.StructuredCommandLineId
	(*BuildEventId_WorkspaceStatusId)(nil),                      // 41: build_event_stream.BuildEventId.WorkspaceStatusId
	(*BuildEventId_OptionsParsedId)(nil),                        // 42: build_event_stream.BuildEventId.OptionsParsedId
	(*BuildEventId_FetchId)(nil),                                // 43: build_event_stream.BuildEventId.FetchId
	(*BuildEventId_PatternExpandedId)(nil),                      // 44: build_event_stream.BuildEventId.PatternExpandedId
	(*BuildEventId_WorkspaceConfigId)(nil),                      // 45: build_event_stream.BuildEventId.WorkspaceConfigId
	(*BuildEventId_BuildMetadataId)(nil),                        // 46: build_event_stream.BuildEventId.BuildMetadataId
	(*BuildEventId_TargetConfiguredId)(nil),                     // 47: build_event_stream.BuildEventId.TargetConfiguredId
	(*BuildEventId_NamedSetOfFilesId)(nil),                      // 48: build_event_stream.BuildEventId.NamedSetOfFilesId
	(*BuildEventId_ConfigurationId)(nil),                        // 49: build_event_stream.BuildEventId.ConfigurationId
	(*BuildEventId_TargetCompletedId)(nil),                      // 50: build_event_stream.BuildEventId.TargetCompletedId
	(*BuildEventId_ActionCompletedId)(nil),                      // 51: build_event_stream.BuildEventId.ActionCompletedId
	(*BuildEventId_UnconfiguredLabelId)(nil),                    // 52: build_event_stream.BuildEventId.UnconfiguredLabelId
	(*BuildEventId_ConfiguredLabelId)(nil),                      // 53: build_event_stream.BuildEventId.ConfiguredLabelId
	(*BuildEventId_TestResultId)(nil),                           // 54: build_event_stream.BuildEventId.TestResultId
	(*BuildEventId_TestProgressId)(nil),                         // 55: build_event_stream.BuildEventId.TestProgressId
	(*BuildEventId_TestSummaryId)(nil),                          // 56: build_event_stream.BuildEventId.TestSummaryId
	(*BuildEventId_TargetSummaryId)(nil),                        // 57: build_event_stream.BuildEventId.TargetSummaryId
	(*BuildEventId_BuildFinishedId)(nil),                        // 58: build_event_stream.BuildEventId.BuildFinishedId
	(*BuildEventId_BuildToolLogsId)(nil),                        // 59: build_event_stream.BuildEventId.BuildToolLogsId
	(*BuildEventId_BuildMetricsId)(nil),                         // 60: build_event_stream.BuildEventId.BuildMetricsId
	(*BuildEventId_ConvenienceSymlinksIdentifiedId)(nil),        // 61: build_event_stream.BuildEventId.ConvenienceSymlinksIdentifiedId
	...
	(*BuildMetrics_EvaluationStat)(nil),                         // 79: build_event_stream.BuildMetrics.EvaluationStat
	(*BuildMetrics_BuildGraphMetrics)(nil),                      // 80: build_event_stream.BuildMetrics.BuildGraphMetrics
	(*BuildMetrics_WorkerMetrics)(nil),                          // 81: build_event_stream.BuildMetrics.WorkerMetrics
	(*BuildMetrics_NetworkMetrics)(nil),                         // 82: build_event_stream.BuildMetrics.NetworkMetrics
	(*BuildMetrics_WorkerPoolMetrics)(nil),                      // 83: build_event_stream.BuildMetrics.WorkerPoolMetrics
	(*BuildMetrics_DynamicExecutionMetrics)(nil),                // 84: build_event_stream.BuildMetrics.DynamicExecutionMetrics
	(*BuildMetrics_RemoteAnalysisCacheStatistics)(nil),          // 85: build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics
	(*BuildMetrics_ActionSummary_ActionData)(nil),               // 86: build_event_stream.BuildMetrics.ActionSummary.ActionData
	(*BuildMetrics_ActionSummary_RunnerCount)(nil),              // 87: build_event_stream.BuildMetrics.ActionSummary.RunnerCount
	(*BuildMetrics_MemoryMetrics_GarbageMetrics)(nil),           // 88: build_event_stream.BuildMetrics.MemoryMetrics.GarbageMetrics
	(*BuildMetrics_ArtifactMetrics_FilesMetric)(nil),            // 89: build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	(*BuildMetrics_BuildGraphMetrics_RuleClassCount)(nil),       // 90: build_event_stream.BuildMetrics.BuildGraphMetrics.RuleClassCount
	(*BuildMetrics_BuildGraphMetrics_AspectCount)(nil),          // 91: build_event_stream.BuildMetrics.BuildGraphMetrics.AspectCount
	(*BuildMetrics_WorkerMetrics_WorkerStats)(nil),              // 92: build_event_stream.BuildMetrics.WorkerMetrics.WorkerStats
	(*BuildMetrics_NetworkMetrics_SystemNetworkStats)(nil),      // 93: build_event_stream.BuildMetrics.NetworkMetrics.SystemNetworkStats
	(*BuildMetrics_WorkerPoolMetrics_WorkerPoolStats)(nil),      // 94: build_event_stream.BuildMetrics.WorkerPoolMetrics.WorkerPoolStats
	(*BuildMetrics_DynamicExecutionMetrics_RaceStatistics)(nil), // 95: build_event_stream.BuildMetrics.DynamicExecutionMetrics.RaceStatistics
	(*timestamppb.Timestamp)(nil),                               // 96: google.protobuf.Timestamp
	(*protobuf.InvocationPolicy)(nil),                           // 97: blaze.invocation_policy.InvocationPolicy
	(*protobuf.FailureDetail)(nil),                              // 98: failure_details.FailureDetail
	(*anypb.Any)(nil),                                           // 99: google.protobuf.Any
	(*durationpb.Duration)(nil),                                 // 100: google.protobuf.Duration
	(*protobuf.CommandLine)(nil),                                // 101: command_line.CommandLine
	(*protobuf.ActionCacheStatistics)(nil),                      // 102: blaze.ActionCacheStatistics
	(*metrics.PackageLoadMetrics)(nil),                          // 103: devtools.build.lib.packages.metrics.PackageLoadMetrics
	(protobuf.Worker_Code)(0),                                   // 104: failure_details.Worker.Code
}
var file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_depIdxs = []int32{
	36,  // 0: build_event_stream.BuildEventId.unknown:type_name -> build_event_stream.BuildEventId.UnknownBuildEventId
	37,  // 1: build_event_stream.BuildEventId.progress:type_name -> build_event_stream.BuildEventId.ProgressId
	38,  // 2: build_event_stream.BuildEventId.started:type_name -> build_event_stream.BuildEventId.BuildStartedId
	39,  // 3: build_event_stream.BuildEventId.unstructured_command_line:type_name -> build_event_stream.BuildEventId.UnstructuredCommandLineId
	40,  // 4: build_event_stream.BuildEventId.structured_command_line:type_name -> build_event_stream.BuildEventId.StructuredCommandLineId
	41,  // 5: build_event_stream.BuildEventId.workspace_status:type_name -> build_event_stream.BuildEventId.WorkspaceStatusId
	42,  // 6: build_event_stream.BuildEventId.options_parsed:type_name -> build_event_stream.BuildEventId.OptionsParsedId
	43,  // 7: build_event_stream.BuildEventId.fetch:type_name -> build_event_stream.BuildEventId.FetchId
	49,  // 8: build_event_stream.BuildEventId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	47,  // 9: build_event_stream.BuildEventId.target_configured:type_name -> build_event_stream.BuildEventId.TargetConfiguredId
	44,  // 10: build_event_stream.BuildEventId.pattern:type_name -> build_event_stream.BuildEventId.PatternExpandedId
	44,  // 11: build_event_stream.BuildEventId.pattern_skipped:type_name -> build_event_stream.BuildEventId.PatternExpandedId
	48,  // 12: build_event_stream.BuildEventId.named_set:type_name -> build_event_stream.BuildEventId.NamedSetOfFilesId
	50,  // 13: build_event_stream.BuildEventId.target_completed:type_name -> build_event_stream.BuildEventId.TargetCompletedId
	51,  // 14: build_event_stream.BuildEventId.action_completed:type_name -> build_event_stream.BuildEventId.ActionCompletedId
	52,  // 15: build_event_stream.BuildEventId.unconfigured_label:type_name -> build_event_stream.BuildEventId.UnconfiguredLabelId
	53,  // 16: build_event_stream.BuildEventId.configured_label:type_name -> build_event_stream.BuildEventId.ConfiguredLabelId
	54,  // 17: build_event_stream.BuildEventId.test_result:type_name -> build_event_stream.BuildEventId.TestResultId
	55,  // 18: build_event_stream.BuildEventId.test_progress:type_name -> build_event_stream.BuildEventId.TestProgressId
	56,  // 19: build_event_stream.BuildEventId.test_summary:type_name -> build_event_stream.BuildEventId.TestSummaryId
	57,  // 20: build_event_stream.BuildEventId.target_summary:type_name -> build_event_stream.BuildEventId.TargetSummaryId
	58,  // 21: build_event_stream.BuildEventId.build_finished:type_name -> build_event_stream.BuildEventId.BuildFinishedId
	59,  // 22: build_event_stream.BuildEventId.build_tool_logs:type_name -> build_event_stream.BuildEventId.BuildToolLogsId
	60,  // 23: build_event_stream.BuildEventId.build_metrics:type_name -> build_event_stream.BuildEventId.BuildMetricsId
	45,  // 24: build_event_stream.BuildEventId.workspace:type_name -> build_event_stream.BuildEventId.WorkspaceConfigId
	46,  // 25: build_event_stream.BuildEventId.build_metadata:type_name -> build_event_stream.BuildEventId.BuildMetadataId
	61,  // 26: build_event_stream.BuildEventId.convenience_symlinks_identified:type_name -> build_event_stream.BuildEventId.ConvenienceSymlinksIdentifiedId
	62,  // 27: build_event_stream.BuildEventId.exec_request:type_name -> build_event_stream.BuildEventId.ExecRequestId
	3,   // 28: build_event_stream.Aborted.reason:type_name -> build_event_stream.Aborted.AbortReason
	96,  // 29: build_event_stream.BuildStarted.start_time:type_name -> google.protobuf.Timestamp
	97,  // 30: build_event_stream.OptionsParsed.invocation_policy:type_name -> blaze.invocation_policy.InvocationPolicy
	63,  // 31: build_event_stream.WorkspaceStatus.item:type_name -> build_event_stream.WorkspaceStatus.Item
	64,  // 32: build_event_stream.BuildMetadata.metadata:type_name -> build_event_stream.BuildMetadata.MetadataEntry
	65,  // 33: build_event_stream.Configuration.make_variable:type_name -> build_event_stream.Configuration.MakeVariableEntry
	66,  // 34: build_event_stream.PatternExpanded.test_suite_expansions:type_name -> build_event_stream.PatternExpanded.TestSuiteExpansion
	0,   // 35: build_event_stream.TargetConfigured.test_size:type_name -> build_event_stream.TestSize
	19,  // 36: build_event_stream.NamedSetOfFiles.files:type_name -> build_event_stream.File
	48,  // 37: build_event_stream.NamedSetOfFiles.file_sets:type_name -> build_event_stream.BuildEventId.NamedSetOfFilesId
	19,  // 38: build_event_stream.ActionExecuted.stdout:type_name -> build_event_stream.File
	19,  // 39: build_event_stream.ActionExecuted.stderr:type_name -> build_event_stream.File
	49,  // 40: build_event_stream.ActionExecuted.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	19,  // 41: build_event_stream.ActionExecuted.primary_output:type_name -> build_event_stream.File
	98,  // 42: build_event_stream.ActionExecuted.failure_detail:type_name -> failure_details.FailureDetail
	96,  // 43: build_event_stream.ActionExecuted.start_time:type_name -> google.protobuf.Timestamp
	96,  // 44: build_event_stream.ActionExecuted.end_time:type_name -> google.protobuf.Timestamp
	99,  // 45: build_event_stream.ActionExecuted.strategy_details:type_name -> google.protobuf.Any
	48,  // 46: build_event_stream.OutputGroup.file_sets:type_name -> build_event_stream.BuildEventId.NamedSetOfFilesId
	19,  // 47: build_event_stream.OutputGroup.inline_files:type_name -> build_event_stream.File
	0,   // 48: build_event_stream.TargetComplete.test_size:type_name -> build_event_stream.TestSize
	22,  // 49: build_event_stream.TargetComplete.output_group:type_name -> build_event_stream.OutputGroup
	19,  // 50: build_event_stream.TargetComplete.important_output:type_name -> build_event_stream.File
	19,  // 51: build_event_stream.TargetComplete.directory_output:type_name -> build_event_stream.File
	100, // 52: build_event_stream.TargetComplete.test_timeout:type_name -> google.protobuf.Duration
	98,  // 53: build_event_stream.TargetComplete.failure_detail:type_name -> failure_details.FailureDetail
	1,   // 54: build_event_stream.TestResult.status:type_name -> build_event_stream.TestStatus
	96,  // 55: build_event_stream.TestResult.test_attempt_start:type_name -> google.protobuf.Timestamp
	100, // 56: build_event_stream.TestResult.test_attempt_duration:type_name -> google.protobuf.Duration
	19,  // 57: build_event_stream.TestResult.test_action_output:type_name -> build_event_stream.File
	67,  // 58: build_event_stream.TestResult.execution_info:type_name -> build_event_stream.TestResult.ExecutionInfo
	1,   // 59: build_event_stream.TestSummary.overall_status:type_name -> build_event_stream.TestStatus
	19,  // 60: build_event_stream.TestSummary.passed:type_name -> build_event_stream.File
	19,  // 61: build_event_stream.TestSummary.failed:type_name -> build_event_stream.File
	96,  // 62: build_event_stream.TestSummary.first_start_time:type_name -> google.protobuf.Timestamp
	96,  // 63: build_event_stream.TestSummary.last_stop_time:type_name -> google.protobuf.Timestamp
	100, // 64: build_event_stream.TestSummary.total_run_duration:type_name -> google.protobuf.Duration
	1,   // 65: build_event_stream.TargetSummary.overall_test_status:type_name -> build_event_stream.TestStatus
	70,  // 66: build_event_stream.BuildFinished.exit_code:type_name -> build_event_stream.BuildFinished.ExitCode
	96,  // 67: build_event_stream.BuildFinished.finish_time:type_name -> google.protobuf.Timestamp
	71,  // 68: build_event_stream.BuildFinished.anomaly_report:type_name -> build_event_stream.BuildFinished.AnomalyReport
	98,  // 69: build_event_stream.BuildFinished.failure_detail:type_name -> failure_details.FailureDetail
	72,  // 70: build_event_stream.BuildMetrics.action_summary:type_name -> build_event_stream.BuildMetrics.ActionSummary
	73,  // 71: build_event_stream.BuildMetrics.memory_metrics:type_name -> build_event_stream.BuildMetrics.MemoryMetrics
	74,  // 72: build_event_stream.BuildMetrics.target_metrics:type_name -> build_event_stream.BuildMetrics.TargetMetrics
	75,  // 73: build_event_stream.BuildMetrics.package_metrics:type_name -> build_event_stream.BuildMetrics.PackageMetrics
	76,  // 74: build_event_stream.BuildMetrics.timing_metrics:type_name -> build_event_stream.BuildMetrics.TimingMetrics
	77,  // 75: build_event_stream.BuildMetrics.cumulative_metrics:type_name -> build_event_stream.BuildMetrics.CumulativeMetrics
	78,  // 76: build_event_stream.BuildMetrics.artifact_metrics:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics
	80,  // 77: build_event_stream.BuildMetrics.build_graph_metrics:type_name -> build_event_stream.BuildMetrics.BuildGraphMetrics
	81,  // 78: build_event_stream.BuildMetrics.worker_metrics:type_name -> build_event_stream.BuildMetrics.WorkerMetrics
	82,  // 79: build_event_stream.BuildMetrics.network_metrics:type_name -> build_event_stream.BuildMetrics.NetworkMetrics
	83,  // 80: build_event_stream.BuildMetrics.worker_pool_metrics:type_name -> build_event_stream.BuildMetrics.WorkerPoolMetrics
	84,  // 81: build_event_stream.BuildMetrics.dynamic_execution_metrics:type_name -> build_event_stream.BuildMetrics.DynamicExecutionMetrics
	85,  // 82: build_event_stream.BuildMetrics.remote_analysis_cache_statistics:type_name -> build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics
	19,  // 83: build_event_stream.BuildToolLogs.log:type_name -> build_event_stream.File
	32,  // 84: build_event_stream.ConvenienceSymlinksIdentified.convenience_symlinks:type_name -> build_event_stream.ConvenienceSymlink
	5,   // 85: build_event_stream.ConvenienceSymlink.action:type_name -> build_event_stream.ConvenienceSymlink.Action
	34,  // 86: build_event_stream.ExecRequestConstructed.environment_variable:type_name -> build_event_stream.EnvironmentVariable
	6,   // 87: build_event_stream.BuildEvent.id:type_name -> build_event_stream.BuildEventId
	6,   // 88: build_event_stream.BuildEvent.children:type_name -> build_event_stream.BuildEventId
	7,   // 89: build_event_stream.BuildEvent.progress:type_name -> build_event_stream.Progress
	8,   // 90: build_event_stream.BuildEvent.aborted:type_name -> build_event_stream.Aborted
	9,   // 91: build_event_stream.BuildEvent.started:type_name -> build_event_stream.BuildStarted
	11,  // 92: build_event_stream.BuildEvent.unstructured_command_line:type_name -> build_event_stream.UnstructuredCommandLine
	101, // 93: build_event_stream.BuildEvent.structured_command_line:type_name -> command_line.CommandLine
	12,  // 94: build_event_stream.BuildEvent.options_parsed:type_name -> build_event_stream.OptionsParsed
	14,  // 95: build_event_stream.BuildEvent.workspace_status:type_name -> build_event_stream.WorkspaceStatus
	13,  // 96: build_event_stream.BuildEvent.fetch:type_name -> build_event_stream.Fetch
	16,  // 97: build_event_stream.BuildEvent.configuration:type_name -> build_event_stream.Configuration
	17,  // 98: build_event_stream.BuildEvent.expanded:type_name -> build_event_stream.PatternExpanded
	18,  // 99: build_event_stream.BuildEvent.configured:type_name -> build_event_stream.TargetConfigured
	21,  // 100: build_event_stream.BuildEvent.action:type_name -> build_event_stream.ActionExecuted
	20,  // 101: build_event_stream.BuildEvent.named_set_of_files:type_name -> build_event_stream.NamedSetOfFiles
	23,  // 102: build_event_stream.BuildEvent.completed:type_name -> build_event_stream.TargetComplete
	24,  // 103: build_event_stream.BuildEvent.test_result:type_name -> build_event_stream.TestResult
	25,  // 104: build_event_stream.BuildEvent.test_progress:type_name -> build_event_stream.TestProgress
	26,  // 105: build_event_stream.BuildEvent.test_summary:type_name -> build_event_stream.TestSummary
	27,  // 106: build_event_stream.BuildEvent.target_summary:type_name -> build_event_stream.TargetSummary
	28,  // 107: build_event_stream.BuildEvent.finished:type_name -> build_event_stream.BuildFinished
	30,  // 108: build_event_stream.BuildEvent.build_tool_logs:type_name -> build_event_stream.BuildToolLogs
	29,  // 109: build_event_stream.BuildEvent.build_metrics:type_name -> build_event_stream.BuildMetrics
	10,  // 110: build_event_stream.BuildEvent.workspace_info:type_name -> build_event_stream.WorkspaceConfig
	15,  // 111: build_event_stream.BuildEvent.build_metadata:type_name -> build_event_stream.BuildMetadata
	31,  // 112: build_event_stream.BuildEvent.convenience_symlinks_identified:type_name -> build_event_stream.ConvenienceSymlinksIdentified
	33,  // 113: build_event_stream.BuildEvent.exec_request:type_name -> build_event_stream.ExecRequestConstructed
	2,   // 114: build_event_stream.BuildEventId.FetchId.downloader:type_name -> build_event_stream.BuildEventId.FetchId.Downloader
	49,  // 115: build_event_stream.BuildEventId.TargetCompletedId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	49,  // 116: build_event_stream.BuildEventId.ActionCompletedId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	49,  // 117: build_event_stream.BuildEventId.ConfiguredLabelId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	49,  // 118: build_event_stream.BuildEventId.TestResultId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	49,  // 119: build_event_stream.BuildEventId.TestProgressId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	49,  // 120: build_event_stream.BuildEventId.TestSummaryId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	49,  // 121: build_event_stream.BuildEventId.TargetSummaryId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	68,  // 122: build_event_stream.TestResult.ExecutionInfo.timing_breakdown:type_name -> build_event_stream.TestResult.ExecutionInfo.TimingBreakdown
	69,  // 123: build_event_stream.TestResult.ExecutionInfo.resource_usage:type_name -> build_event_stream.TestResult.ExecutionInfo.ResourceUsage
	68,  // 124: build_event_stream.TestResult.ExecutionInfo.TimingBreakdown.child:type_name -> build_event_stream.TestResult.ExecutionInfo.TimingBreakdown
	100, // 125: build_event_stream.TestResult.ExecutionInfo.TimingBreakdown.time:type_name -> google.protobuf.Duration
	86,  // 126: build_event_stream.BuildMetrics.ActionSummary.action_data:type_name -> build_event_stream.BuildMetrics.ActionSummary.ActionData
	87,  // 127: build_event_stream.BuildMetrics.ActionSummary.runner_count:type_name -> build_event_stream.BuildMetrics.ActionSummary.RunnerCount
	102, // 128: build_event_stream.BuildMetrics.ActionSummary.action_cache_statistics:type_name -> blaze.ActionCacheStatistics
	88,  // 129: build_event_stream.BuildMetrics.MemoryMetrics.garbage_metrics:type_name -> build_event_stream.BuildMetrics.MemoryMetrics.GarbageMetrics
	103, // 130: build_event_stream.BuildMetrics.PackageMetrics.package_load_metrics:type_name -> devtools.build.lib.packages.metrics.PackageLoadMetrics
	100, // 131: build_event_stream.BuildMetrics.TimingMetrics.critical_path_time:type_name -> google.protobuf.Duration
	89,  // 132: build_event_stream.BuildMetrics.ArtifactMetrics.source_artifacts_read:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	89,  // 133: build_event_stream.BuildMetrics.ArtifactMetrics.output_artifacts_seen:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	89,  // 134: build_event_stream.BuildMetrics.ArtifactMetrics.output_artifacts_from_action_cache:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	89,  // 135: build_event_stream.BuildMetrics.ArtifactMetrics.top_level_artifacts:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	79,  // 136: build_event_stream.BuildMetrics.BuildGraphMetrics.dirtied_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	79,  // 137: build_event_stream.BuildMetrics.BuildGraphMetrics.changed_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	79,  // 138: build_event_stream.BuildMetrics.BuildGraphMetrics.built_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	79,  // 139: build_event_stream.BuildMetrics.BuildGraphMetrics.cleaned_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	79,  // 140: build_event_stream.BuildMetrics.BuildGraphMetrics.evaluated_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	90,  // 141: build_event_stream.BuildMetrics.BuildGraphMetrics.rule_class:type_name -> build_event_stream.BuildMetrics.BuildGraphMetrics.RuleClassCount
	91,  // 142: build_event_stream.BuildMetrics.BuildGraphMetrics.aspect:type_name -> build_event_stream.BuildMetrics.BuildGraphMetrics.AspectCount
	4,   // 143: build_event_stream.BuildMetrics.WorkerMetrics.worker_status:type_name -> build_event_stream.BuildMetrics.WorkerMetrics.WorkerStatus
	104, // 144: build_event_stream.BuildMetrics.WorkerMetrics.code:type_name -> failure_details.Worker.Code
	92,  // 145: build_event_stream.BuildMetrics.WorkerMetrics.worker_stats:type_name -> build_event_stream.BuildMetrics.WorkerMetrics.WorkerStats
	93,  // 146: build_event_stream.BuildMetrics.NetworkMetrics.system_network_stats:type_name -> build_event_stream.BuildMetrics.NetworkMetrics.SystemNetworkStats
	94,  // 147: build_event_stream.BuildMetrics.WorkerPoolMetrics.worker_pool_stats:type_name -> build_event_stream.BuildMetrics.WorkerPoolMetrics.WorkerPoolStats
	95,  // 148: build_event_stream.BuildMetrics.DynamicExecutionMetrics.race_statistics:type_name -> build_event_stream.BuildMetrics.DynamicExecutionMetrics.RaceStatistics
	100, // 149: build_event_stream.BuildMetrics.ActionSummary.ActionData.system_time:type_name -> google.protobuf.Duration
	100, // 150: build_event_stream.BuildMetrics.ActionSummary.ActionData.user_time:type_name -> google.protobuf.Duration
...
func init() {
	file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_init()
}
func file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_init() {
	if File_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto != nil {
		return
	}
	file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[13].OneofWrappers = []any{
		(*File_Uri)(nil),
		(*File_Contents)(nil),
		(*File_SymlinkTargetPath)(nil),
	}
	file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[29].OneofWrappers = []any{
	...
	file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes[75].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDesc), len(file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   90,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_goTypes,
		DependencyIndexes: file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_depIdxs,
		EnumInfos:         file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_enumTypes,
		MessageInfos:      file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_msgTypes,
	}.Build()
	File_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto = out.File
	file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_goTypes = nil
	file_src_main_java_com_google_devtools_build_lib_buildeventstream_build_event_stream_proto_depIdxs = nil
}
